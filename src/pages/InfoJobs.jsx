...
function InfoJobs({ handleTheDetailPage }) {
  ...
  return (
    <div className="flex flex-col items-center h-fit">
      <div className="grid grid-cols1-1 gap-3 p-3 h-fit overflow-hidden sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
        {jobs.slice(0, 6).map((job) => (
          <div className="card w-96 bg-base-100 shadow-xl">
            {/* <figure>
            <img
              src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/514c0c6c-8c60-4d65-94c4-73158a3028be/invincible-3-mens-road-running-shoes-CLdFjq.png"
              alt="Shoes"
            />
          </figure> */}
